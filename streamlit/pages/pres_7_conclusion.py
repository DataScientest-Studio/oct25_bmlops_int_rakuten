...
def show():
    ...
    **(1) Automated processes**   
    ...
    Adding a FileSensor or similar (--> more automation)


    **(2) User interactions possible**   
    ...
    **(4) 'Best' Model available and ensured**   
    ✅ Suitable model at hand
    ✅ Tracked its building (**MLflow**)   
    Model selection: also tried FAISS but not completed   
